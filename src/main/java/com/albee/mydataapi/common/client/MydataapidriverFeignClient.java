...
public interface MydataapidriverFeignClient {
    ...
    @PostMapping(value = "/trans-request-003", produces = "application/json", consumes = "application/json")
    ResponseEntity<ResponseDto<Map<String, String>>> replyTransRequestProcResult(@RequestBody ReplyTransRequestProcResult dom);
