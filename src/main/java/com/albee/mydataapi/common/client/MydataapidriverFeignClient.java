...
public interface MydataapidriverFeignClient {
    ...
    @PostMapping(value = "/offerer/toal-auth-002", produces = "application/json", consumes = "application/json")
    ...
    @PostMapping(value = "/potal/trans-request-003", produces = "application/json", consumes = "application/json")
