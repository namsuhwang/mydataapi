...
public class CallMyDataGatewayServiceImpl implements CallMyDataGatewayService {
    ...
    public <T> ApiCallResponseInfoDto callMyDataApi(ApiCallRequestInfoDto reqInfo, T classType) {
        ...
        try {
            ...
            // resultData = new ObjectMapper().readValue(resInfo.getResultJson(), Class.forName("com.kpcnc.mydataapi.api.common.gateway.models.in" + reqInfo.getRequestApiId() + "InDto"));
