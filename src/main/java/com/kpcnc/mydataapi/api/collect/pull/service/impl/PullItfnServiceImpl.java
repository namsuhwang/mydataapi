...
import com.kpcnc.mydataapi.api.base.itfn.models.*;
import com.kpcnc.mydataapi.api.base.itfn.models.entity.*;
import com.kpcnc.mydataapi.api.base.itfn.models.form.*;
import com.kpcnc.mydataapi.api.base.itfn.service.*;
import com.kpcnc.mydataapi.api.collect.pull.models.dto.BankParamsDto;
import com.kpcnc.mydataapi.api.collect.pull.models.dto.ItfnParamsDto;
import com.kpcnc.mydataapi.api.collect.pull.service.PullItfnService;
...
import com.kpcnc.mydataapi.api.common.gateway.models.res.itfn.*;
...
public class PullItfnServiceImpl implements PullItfnService {
    ...
    @Autowired ItfnAccService itfnAccService;
    @Autowired ItfnLeaseHistService itfnLeaseHistService;
    @Autowired ItfnLeaseService itfnLeaseService;
    @Autowired ItfnLoanService itfnLoanService;
    @Autowired ItfnLoanAddService itfnLoanAddService;
    @Autowired ItfnLoanHistService itfnLoanHistService;
    @Autowired ItfnLoanHistIntService itfnLoanHistIntService;

    @Async("pullPersonalInfoExecutor")
    public CompletableFuture<List<String>> pullItfnInfoRun(ApiCallReqDto req, FormBase formBase) {
