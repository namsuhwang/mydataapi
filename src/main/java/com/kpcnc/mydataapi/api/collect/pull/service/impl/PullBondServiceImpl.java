...
import com.kpcnc.mydataapi.api.base.bond.service.BondService;
...
import com.kpcnc.mydataapi.api.collect.pull.service.PullBondService;
...
import com.kpcnc.mydataapi.api.common.gateway.models.res.bond.*;
import com.kpcnc.mydataapi.api.common.gateway.models.res.card.Card001ResDetailDto;
import com.kpcnc.mydataapi.api.common.gateway.models.res.card.Card001ResDto;
...
public class PullBondServiceImpl implements PullBondService {
    ...
    @Autowired BondBalService bondBalService;
    @Autowired BondHistService bondHistService;
