package com.abcc.mydataapi.api.common.gateway.service.impl;
...
import com.abcc.mydataapi.api.common.gateway.models.res.ResBaseListDto;
...
public class CallMyDataGatewayServiceImpl implements CallMyDataGatewayService {
    ...
    public <T> ApiCallResDto callMyDataApi(ApiCallReqDto reqInfo, T classType) {
        ...
        try {
            ...
            // resultData = new ObjectMapper().readValue(resInfo.getResultJson(), Class.forName("com.abcc.mydataapi.api.common.gateway.models.in" + reqInfo.getRequestApiId() + "InDto"));
